    ...
    return (
        <>
            ...
            <div key={collection.id} className="text-white font-workSans">
                {collection.banner && <div className="bg-cover h-96 bg-center" style={{ backgroundImage: `url(${collection.banner})`}}>
                </div>}
                    ...
                    <div className="mt-10">
                        <div className="flex place-items-center md:place-items-left">
                            <div className="mr-20">
                                ...
                                <p className="text-[0.9rem] lg:text-[1.2rem]">Total Sales (ETH)</p>
                            </div>
                            <div className="mr-20">
                                <h4 className="font-spaceMono text-[1.5rem] lg:text-[1.9rem] font-black">{collection.tokenCount}</h4>
