      ...
      while (retryCount < maxRetries) {
        try {
          const nftsResponse = await fetch(
            "https://us-central1-nft-market-cdc31.cloudfunctions.net/api/tokens",
          );
          ...
          const collectionsResponse = await fetch(
            "https://us-central1-nft-market-cdc31.cloudfunctions.net/api/collections",
          );
          const collectionsData = await collectionsResponse.json();
          setCollectionsData(collectionsData.collections);

          const rankingsOneDayResponse = await fetch(
            "https://us-central1-nft-market-cdc31.cloudfunctions.net/api/collections-one-day",
          );
          const rankingsOneDayData = await rankingsOneDayResponse.json();
          setRankingsOneDay(rankingsOneDayData.collections);

          const rankingsSevenDaysResponse = await fetch(
            "https://us-central1-nft-market-cdc31.cloudfunctions.net/api/collections-seven-days",
          );
          const rankingsSevenDaysData = await rankingsSevenDaysResponse.json();
          setRankingsSevenDays(rankingsSevenDaysData.collections);

          const rankingsThirtyDaysResponse = await fetch(
            "https://us-central1-nft-market-cdc31.cloudfunctions.net/api/collections-thirty-days",
          );
          const rankingsThirtyDaysData =
            await rankingsThirtyDaysResponse.json();
