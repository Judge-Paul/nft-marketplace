...
export default function HowItWorks() {
	return (
		<div className="mt-20 mb-20 font-workSans mx-auto max-w-7xl">
			<div className="px-8 sm:px-32 2xl:px-0 text-white mb-10">
				<h4 className="text-3xl lg:text-[2.5rem] font-bold">How It Works</h4>
				<p className="text-lg lg:text-[1.35rem] mt-5 font-medium">
					Find Out How To Get Started
				</p>
			</div>
			<div className="block md:flex px-8 lg:px-20 xl:px-32 2xl:px-0 gap-7">
