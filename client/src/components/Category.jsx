...
export default function Category() {
	return (
		<div className="px-8 sm:px-32 mt-20 mb-20 lg:mb-36 max-w-7xl mx-auto 2xl:px-0">
			...
			<div className="grid grid-cols-2 lg:grid-cols-4 gap-7">
				...
				/>
				<CategoryCard
					backgroundImage={UtilityBG}
					icon={<FaMagic />}
					name="Utility"
				/>
				<CategoryCard
					backgroundImage={SportBG}
					icon={<IoFootball />}
					name="Sport"
				/>
				<CategoryCard
					backgroundImage={VirtualWordsBG}
